...
const fallbackImage: string = "https://res.cloudinary.com/avdhesh-varshney/image/upload/v1724597541/projects.png";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    metadataBase: new URL(`https://avdhesh-portfolio.vercel.app/projects/${project.slug}`),
    description: project.tagline,
    openGraph: {
      images: project.coverImage
        ? urlFor(project.coverImage.image).width(1200).height(630).url()
        : fallbackImage,
      url: `https://avdhesh-portfolio.vercel.app/projects/${project.slug}`,
      title: project.name,
      description: project.tagline,
    },
  };
